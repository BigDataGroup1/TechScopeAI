"""Intelligent patent question analyzer - analyzes company data and determines what questions to ask."""
...
class PatentQuestionAnalyzer:
    """Analyzes company data and determines which patent questions need to be asked."""
    
    # Field mappings: questionnaire_id -> company_data fields to check
    FIELD_MAPPINGS = {
        "industry": ["industry", "basic_info.industry"]
    }
