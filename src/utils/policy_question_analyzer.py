"""Intelligent policy question analyzer - analyzes company data and determines what questions to ask."""
...
class PolicyQuestionAnalyzer:
    """Analyzes company data and determines which policy questions need to be asked."""
